 ...
 */
- (NSString *_Nonnull)getMainViewController;
 ...
 *  @return 返回ViewController
 */
- (NSString *_Nonnull)getQRCodeViewController;
 ...
 *  @return 返回ViewController
 */
- (NSString *_Nonnull)getScannerViewController;
 ...
 *  @param fail 失败回调
 */
- (void)updateAvatarURL:(NSString *_Nonnull)avatarURL succ:(_Nullable HRIMSDKSucc)succ fail:(_Nullable HRIMSDKFail)fail;
